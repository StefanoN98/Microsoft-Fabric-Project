...
The full notebook is available here: [NB_Silver_Analyze_Load_erp_tables.ipynb](../../fabric_workspace/02.%20silver_layer/NB_Silver_Analyze_Load_erp_tables.ipynb.ipynb)
