...
3. [Pipeline: Silver_Pipeline](#pipeline-silver_pipeline)
    - [Branch 1 — Marketing & Ecommerce](#branch-1---marketing--ecommerce)
    - [Branch 2 — Product Catalog](#branch-2---product-catalog)
    - [ERP Tables (Notebook)](#erp-tables-notebook)
    - [Sales Tables (Notebook)](#sales-tables-notebook)
    - [CRM Tables (Dataflow Gen2)](#crm-tables-dataflow-gen2)

4. [Resulting Silver Tables & Folder Structure in LH_Silver](#resulting-silver-tables--folder-structure-in-lh_silver)
...
<img src="../Images/silver/product_catalog_attributes_images.png" width="700"/>
...
<img src="../Images/silver/dataflow_gen2_crm.png" width="800"/>
...
| silver_product_catalog | Product Catalog (Notebook, flattened) |
| silver_marketing_campaigns | Marketing (Copy Activity) |
| silver_web_logs | Ecommerce (Copy Activity) |
| silver_orders | Sales(Notebook) |
| silver_order_details | Sales (Notebook) |
| silver_reviews | Sales(Notebook) |
| silver_order_campaign | Sales (Notebook) |
...
└── Tables
     ...
     ├── silver_customers
     ├── silver_inventory
     ├── silver_legacy_customers
     ├── silver_marketing_campaigns
     ├── silver_order_campaign
