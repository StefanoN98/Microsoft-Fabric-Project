...
---
## Table of Contents
[Fabric Objects & Structure](#fabric-objects--structure)

[Metadata-Driven Ingestion](#metadata-driven-ingestion)

[Pipeline: PL_INGEST](#pipeline-pl_ingest)
...
[Resulting Bronze Tables](#resulting-bronze-tables)

[Folder Structure in LH_Bronze](#folder-structure-in-lh_bronze)
