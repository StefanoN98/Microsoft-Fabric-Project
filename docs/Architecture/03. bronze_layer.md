...
3. [Pipeline: PL_INGEST](#pipeline-pl_ingest)
   ...
   - [From Files to Delta Tables: NB_Bronze_Files_To_Delta](#from-files-to-delta-tables-nb_bronze_files_to_delta)

4. [Resulting Bronze Tables & Folder Structure in LH_Bronze](#resulting-bronze-tables--folder-structure-in-lh_bronze)
...
# Architecture
<img src="../Images/bronze/bronze_layer_architecture.png" width="1000"/>
...
Also the destination path is dynamically generated pasting the data into the LH_Bronze with the following logic: `@item().DestinationFolder / @item().ObjectName`
